...
def extract_lead_from_user_message(message: str, existing: LeadInfo) -> LeadInfo:
    ...
    if location_match:
        ...
        known_locations = {
            ...
            "hyderabad", "chennai", "delhi", "new delhi", "gurgaon", "gurugram",
            "noida", "kolkata", "ahmedabad", "surat", "jaipur", "lucknow",
        }
        if normalized in known_locations:
            updated["location"] = " ".join(word.capitalize() for word in normalized.split())
